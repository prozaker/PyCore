...
from subspace.encryption import SubspaceEncryption
from subspace.file_checksum import FileChecksum


def get_tick_count_hs():
    """Tick count in hundreths of a second."""
    return math.trunc(time.clock() * 100) & 0xFFFFFFFF


def tick_diff(now, base):
